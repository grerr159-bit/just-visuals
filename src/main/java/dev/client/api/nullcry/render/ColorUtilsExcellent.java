...
import dev.client.api.nullcry.helper.math.Interpolator;
...
@UtilityClass
public class ColorUtilsExcellent {
    ...
    public int overCol(int color1, int color2, float percent01) {
        ...
        return getColor(
                Interpolator.linear(red(color1), red(color2), percent),
                Interpolator.linear(green(color1), green(color2), percent),
                Interpolator.linear(blue(color1), blue(color2), percent),
                Interpolator.linear(alpha(color1), alpha(color2), percent)
        );
    }
